...
const SignUp: React.FC<SignUpProps> = ({
  ...
  return (
    <form onSubmit={onSubmit}> 
      ...
      <div className="mt-6">
        <button type="submit" className="w-full px-6 py-3 text-sm font-medium tracking-wide te capitalize transition-colors duration-300 transSignUp bg-blue-500 rounded-lg hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
          Sign Up
        </button>
